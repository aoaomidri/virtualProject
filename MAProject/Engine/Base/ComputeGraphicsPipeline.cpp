...
//	rootParameter[8].Descriptor.ShaderRegister = 5;
//
//	//Samplerの設定
...
//	rootParameter[4].DescriptorTable.pDescriptorRanges = &descriptorRange[0];
...
//	rootParameter[8].ShaderVisibility = D3D12_SHADER_VISIBILITY_PIXEL;
//	rootParameter[8].DescriptorTable.pDescriptorRanges = &descriptorRange[2];
...
void ComputeGraphicsPipeline::Initialize(const std::wstring& VSname, const std::wstring& PSname, bool isCulling){
...
void ComputeGraphicsPipeline::makeInputLayout(){

}

void ComputeGraphicsPipeline::makeRasterizerState(bool isCulling){

}

void ComputeGraphicsPipeline::ShaderCompile(const std::wstring& VSname, const std::wstring& PSname){
	
}

void ComputeGraphicsPipeline::makeDepthStencil(D3D12_DEPTH_WRITE_MASK depthWriteMask){
