...
void PlayerJustAvoid::ApplyGlobalVariables(){

}

void PlayerJustAvoid::InitGlobalVariables() const{

}

void PlayerJustAvoid::Initialize(){
	BasePlayerState::Initialize();
	InitializeMove();
	InitializeAttack();
}

void PlayerJustAvoid::InitializeMove(){
...
void PlayerJustAvoid::Update(const Vector3& cameraRotate){
